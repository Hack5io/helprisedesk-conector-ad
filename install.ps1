...
# 2) Escribir config.json -- nunca se guarda en el propio HelpriseDesk,
...
# 3) Registrar y arrancar el servicio (ver internal/service en el binario, via kardianos/service).
